...
+ (NSAttributedString*)attributedStringWithString:(NSString*)string font:(UIFont*)font textColor:(UIColor*)color;
- (id)initWithString:(NSString*)string font:(UIFont*)font textColor:(UIColor*)color;
